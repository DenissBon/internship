...
public class adminLogoutValidation extends CommonFunctions {
    ...
    public void i_click_Logout_from_drop_down()   {
    ...
    public void i_am_on_login_page(String baseUrl)   {
    ...
    public void i_press_tab_to_reach_Logout_from_drop_down()   {
